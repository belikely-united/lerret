 ...
 */
function buildVirtualModuleSource({ project, assetBaseUrl, projectRoot, lerretDir, epoch, cascadeEntries, overrides }) {
  return [
    ...
    `export default { project, assetBaseUrl, projectRoot, lerretDir, epoch, cascadeEntries, overrides, mode };`,
    '',
  ].join('\n');
}
