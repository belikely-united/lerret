...
// `launchHeadlessBrowser` lives in ./browser-launch.js (shared with the PDF
// endpoint without an import cycle); imported above and re-exported here so
// existing callers that import it from this module keep working.
export { launchHeadlessBrowser };
