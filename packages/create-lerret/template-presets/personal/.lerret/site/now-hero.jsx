// "/now" page hero (1200 × 400).
//
// The wide banner at the top of your /now page (see nownownow.com for the
// genre). Date stamp on the left, short status line on the right.

export const meta = {
  dimensions: { width: 1200, height: 400 },
  label: '/now page hero',
  tags: ['personal', 'now', 'hero', 'banner'],
  propsSchema: {
    month: {
      type: 'string',
      default: 'May 2026',
      description: 'Big month label on the left.',
    },
    headline: {
      type: 'string',
      default: 'Building Lerret. Walking lots. Reading Borges.',
      description: 'One-sentence status update.',
      required: true,
    },
    location: {
      type: 'string',
