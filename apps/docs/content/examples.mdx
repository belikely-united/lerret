...
**Use case.** One file, three theme variants, one canvas. The component is exported four times: a default plus three named variants. Lerret renders four artboards from this single file.
